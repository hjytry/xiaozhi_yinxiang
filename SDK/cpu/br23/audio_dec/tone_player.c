...
#endif
    [IDEX_TONE_ALARM1] 			= SDFILE_RES_ROOT_PATH"tone/alarm1.*",
    [IDEX_TONE_ALARM2] 			= SDFILE_RES_ROOT_PATH"tone/alarm2.*",
    [IDEX_TONE_ALARM3] 			= SDFILE_RES_ROOT_PATH"tone/alarm3.*",
    [IDEX_TONE_ALARM4] 			= SDFILE_RES_ROOT_PATH"tone/alarm4.*",
    [IDEX_TONE_ALARM5] 			= SDFILE_RES_ROOT_PATH"tone/alarm4.*",
} ;
