...
bool reset_of_8sec_flag = FALSE;
bool reset_of_normal_flag = FALSE;
...
void setup_arch()
{
    ...
    if(power_reset_src == 0x10){
        // reset_of_8sec_flag = TRUE;
    }else{
        // reset_of_normal_flag = TRUE;
    }
    r_printf("power_reset_src == %d",power_reset_src);
