...
enum {
    ...
    KEY_RTC_0_SHORT,
    KEY_RTC_1_SHORT,
    KEY_RTC_1_LONG_PRESS,
    KEY_RTC_1_HOLD_PRESS,
    KEY_RTC_2_SHORT,
    KEY_RTC_2_LONG_PRESS,
    KEY_RTC_2_HOLD_PRESS,
    KEY_RTC_3_SHORT,
    KEY_RTC_3_LONG_PRESS,
    KEY_RTC_3_HOLD_PRESS,
    KEY_RTC_6_SHORT,
    KEY_RTC_6_LONG_PRESS,
    KEY_RTC_7_SHORT,
    KEY_RTC_7_LONG_PRESS,
    KEY_RTC_8_SHORT,
    KEY_RTC_8_LONG_PRESS,
    KEY_RTC_SW_24_12H,
    KEY_TO_SW_RGB,
    //在这里增加元素
    KEY_TO_ADJUST_BRIGHT,
    KEY_TO_ADJUST_UP_BRIGHT,
    KEY_TO_ADJUST_DOWN_BRIGHT,
    KEY_TO_OPEN_BRIGHT,
    KEY_TO_CLOSE_BRIGHT,
    KET_TO_SW_ALARM_CLOCK_DISPLAY,
    KET_TO_SET_ALARM_CLOCK,
    KEY_TO_UP_CLOCK,
    KEY_TO_DOWM_CLOCK,
    KEY_TO_ALARM_SLEEP,
    KEY_USER_POWEROFF,
    KEY_USER_POWEROFF_HOLD,
    KEY_UP_USER_POWEROFF,
    KEY_TO_ALARM_UNSLEEP,
    KEY_MUSIC_CHANGE_REPEAT_ONE_ALL,
    KEY_TO_PP_NETWORK_FM,
    KEY_LIGHTING_SW,
    KEY_LIGHTING_CLOSE,
    //
    KEY_HID_MODE_SWITCH,
