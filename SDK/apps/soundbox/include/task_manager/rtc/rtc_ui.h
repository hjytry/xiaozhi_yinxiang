...
enum rtc_menu_mode {
    ...
    UI_RTC_ACTION_WEEK_SET,    //设置星期
    UI_RTC_TEMPERATURE_SET,     //设置温度
    UI_ALARM_ACTION_SHOW_TIME,
    UI_RTC_TONE_SET,
    UI_ALARM_ACTION_HOUR_SET,
    UI_ALARM_ACTION_MINUTE_SET,
    UI_RTC_BATTERY_SET,  //设置电量
    UI_ALARM_ACTION_MODE_SET,
};
