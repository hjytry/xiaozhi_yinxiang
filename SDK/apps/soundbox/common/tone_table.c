...
const char *tone_table[] = {
    ...
    [IDEX_TONE_ALARM1] 			= TONE_RES_ROOT_PATH"tone/alarm1.*",
    [IDEX_TONE_ALARM2] 			= TONE_RES_ROOT_PATH"tone/alarm2.*",
    [IDEX_TONE_ALARM3] 			= TONE_RES_ROOT_PATH"tone/alarm3.*",
    [IDEX_TONE_ALARM4] 			= TONE_RES_ROOT_PATH"tone/alarm4.*",
    [IDEX_TONE_ALARM5] 			= TONE_RES_ROOT_PATH"tone/alarm5.*",
    [IDEX_TONE_NONE] 			= TONE_RES_ROOT_PATH"tone/none.*",
};
