...
static RTC_SIMULATE_VAR rtc_smulate_var sec(.fake_time) = {
...
void set_fake_rtc_tick(u64 actual_ns)
{
...
void  get_sys_simulate_time(void)
{
    r_printf("sys_alarm_time: %d-%d-%d %d:%d:%d\n",
