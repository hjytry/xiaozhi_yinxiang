...
*/
/*----------------------------------------------------------------------------*/
extern u8 user_poweroff_cnt;
extern bool user_poweroff_flag;
extern bool user_poweroff_cnt_flag;
extern u8 user_power_on_flag;
    ...
    case KEY_POWER_ON:
        {
            ...
            u8 user_power_flag = KEY_POWER_ON;
...
void idle_app_open_module()
{
    ...
    extern void user_add_modul(void);
    extern void del_idle_vbat_check(void);
    extern void vbat_check_init(void);
    user_add_modul();
    del_idle_vbat_check();
    vbat_check_init();
#if GET_TEMPERATURE_ENABLE||TCFG_APP_LINEIN_EN
    gpio_set_pull_up(USER_SD_POWER_IO, 1);
...
static void idle_app_start()
{
    ...
    UI_HIDE_WINDOW(ID_WINDOW_CLOCK);
...
#endif
    user_poweroff_cnt = 0;
    user_poweroff_flag = FALSE;
    user_poweroff_cnt_flag = FALSE;
    user_power_on_flag = TRUE;
    extern void idle_vbat_check_init(void);
    extern void del_vbat_timer_normal(void);
    del_vbat_timer_normal();
    idle_vbat_check_init();
#if GET_TEMPERATURE_ENABLE||TCFG_APP_LINEIN_EN
