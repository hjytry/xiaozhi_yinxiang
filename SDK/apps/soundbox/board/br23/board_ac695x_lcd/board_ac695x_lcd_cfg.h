...
#define TCFG_ADKEY_AD2      (0x3ffL * 330  / (330  + R_UP))     //9.1k
#define TCFG_ADKEY_AD3      (0x3ffL * 1000 / (1000 + R_UP))     //15k
#define TCFG_ADKEY_AD4      (0x3ffL * 2200 / (2200  + R_UP))     //24k
...
#else
#define TCFG_USE_FAKE_RTC                   DISABLE
#endif
