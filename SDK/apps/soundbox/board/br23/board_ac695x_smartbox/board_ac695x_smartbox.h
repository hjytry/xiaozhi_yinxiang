...
#define TCFG_UART0_TX_PORT  				IO_PORTC_06//IO_PORTC_05                            //串口发送脚配置
...
#define TCFG_KEY_TONE_EN					0//ENABLE		// 按键提示音
...
#if ((TCFG_UART0_ENABLE == ENABLE_THIS_MOUDLE)&&(TCFG_UART0_TX_PORT == IO_PORT_DM))
#define SECOND_KEY_ENABLE                   1
#else
#define SECOND_KEY_ENABLE                   1
#endif
...
#define TCFG_ADKEY_AD2      (0x3ffL * 330   / (330   + R_UP))   //33k
#define TCFG_ADKEY_AD3      (0x3ffL * 510   / (510   + R_UP))   //51k
#define TCFG_ADKEY_AD4      (0x3ffL * 1000  / (1000   + R_UP)) //100k
#define TCFG_ADKEY_AD5      (0x3ffL * 2000  / (2000  + R_UP))   //200k
...
#define TCFG_ADKEY_VOLTAGE5 ((TCFG_ADKEY_AD5 + TCFG_ADKEY_VDDIO) / 2)
...
#if SECOND_KEY_ENABLE
//第二组ADKEY
#define TCFG_ADKEY1_PORT                     IO_PORTA_12        //AD按键端口(需要注意选择的IO口是否支持AD功能)
#define TCFG_ADKEY1_AD_CHANNEL               AD_CH_PA12

//必须从小到大填电阻，没有则同VDDIO,填0x3ffL
#define TCFG_ADKEY1_AD0      (0)                                 //0R
#define TCFG_ADKEY1_AD1      (0x3ffL * 75   / (75   + R_UP))     //7.5k
#define TCFG_ADKEY1_AD2      (0x3ffL * 150   / (150   + R_UP))   //15k
#define TCFG_ADKEY1_AD3      (0x3ffL * 330   / (330   + R_UP))   //33k
#define TCFG_ADKEY1_VDDIO    (0x3ffL)

#define TCFG_ADKEY1_VOLTAGE0 ((TCFG_ADKEY1_AD0 + TCFG_ADKEY1_AD1) / 2)
#define TCFG_ADKEY1_VOLTAGE1 ((TCFG_ADKEY1_AD1 + TCFG_ADKEY1_AD2) / 2)
#define TCFG_ADKEY1_VOLTAGE2 ((TCFG_ADKEY1_AD2 + TCFG_ADKEY1_AD3) / 2)
#define TCFG_ADKEY1_VOLTAGE3 ((TCFG_ADKEY1_AD3 + TCFG_ADKEY_VDDIO) / 2)

#define TCFG_ADKEY1_VALUE0                   0
#define TCFG_ADKEY1_VALUE1                   1
#define TCFG_ADKEY1_VALUE2                   2
#define TCFG_ADKEY1_VALUE3                   3
#endif
...
#define LINEIN_INPUT_WAY            LINEIN_INPUT_WAY_DAC //LINEIN_INPUT_WAY_ANALOG
...
#define TONE_MODE_DEFAULE_VOLUME            (23)
//*********************************************************************************//
//                                  充电仓配置                                     //
//*********************************************************************************//
...
#define TCFG_LOWPOWER_VDDIOM_LEVEL			VDDIOM_VOL_36V
...
#define TCFG_PHONE_EQ_ENABLE                0//1     //支持通话近端EQ
#define TCFG_MUSIC_MODE_EQ_ENABLE           TCFG_APP_MUSIC_EN     //支持音乐模式EQ
#define TCFG_LINEIN_MODE_EQ_ENABLE          0//TCFG_APP_LINEIN_EN     //支持linein近端EQ
#define TCFG_FM_MODE_EQ_ENABLE              0//TCFG_APP_FM_EN     //支持fm模式EQ
#define TCFG_SPDIF_MODE_EQ_ENABLE           0//TCFG_APP_SPDIF_EN     //支持SPDIF模式EQ
#define TCFG_PC_MODE_EQ_ENABLE              0//TCFG_APP_PC_EN     //支持pc模式EQ
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		    (10*60)//0   //没有蓝牙连接自动关机时间
#define TCFG_SYS_LVD_EN						1   //电量检测使能
#define TCFG_POWER_ON_NEED_KEY				1	  //是否需要按按键开机配置
#define TWFG_APP_POWERON_IGNORE_DEV         500//上电忽略挂载设备，0时不忽略，非0则n毫秒忽略
...
#define UPDATE_MD5_ENABLE            0//1     //升级是否支持MD5校验
#define RCSP_FILE_OPT				 0//1
#define JL_EARPHONE_APP_EN			 0//1
#define TCFG_LFN_EN					 0//1
#define TCFG_BS_DEV_PATH_EN			 0//1
#else
...
#define TCFG_LINEIN_LR_CH					AUDIO_LIN_DACR_CH
...
#define TCFG_LINEIN_AD_CHANNEL             	AD_CH_PB8		// 检测IO是否使用AD检测
#define TCFG_LINEIN_VOLTAGE                	950					// AD检测时的阀值
...
#define TCFG_FM_INSIDE_ENABLE					0//ENABLE
...
#define TCFG_IIS_OUTPUT_EN                    0//ENABLE //
...
#define TCFG_ENC_G726_ENABLE               0//ENABLE
#define TCFG_ENC_MP3_ENABLE                0//ENABLE
#define TCFG_ENC_ADPCM_ENABLE              0//ENABLE
#define TCFG_ENC_PCM_ENABLE                0//ENABLE
#define TCFG_ENC_SBC_ENABLE                0//ENABLE
