...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    // [0] = {
    //     KEY_RTC_0_SHORT,	KEY_CALL_HANG_UP,	KEY_USER_POWEROFF_HOLD,			KEY_UP_USER_POWEROFF,		KEY_TO_PP_NETWORK_FM,	KEY_NULL
    // },
    // [1] = {
    //     KEY_NULL,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,			KEY_NULL,		KEY_NULL,	KEY_NULL
    // },
    [0] = {
        KEY_RTC_0_SHORT,	KEY_CALL_HANG_UP,	KEY_POWEROFF_HOLD,			KEY_NULL,		KEY_TO_PP_NETWORK_FM,	KEY_NULL
    },
    [1] = {
...
const u16 fm_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    // [0] = {
    //     KEY_RTC_0_SHORT,	KEY_USER_POWEROFF,	KEY_USER_POWEROFF_HOLD,			KEY_UP_USER_POWEROFF,		KEY_TO_PP_NETWORK_FM,	KEY_NULL
    // },
    // [1] = {
    //     KEY_NULL,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,			KEY_NULL,		KEY_NULL,	KEY_NULL
    // },
    [0] = {
        KEY_RTC_0_SHORT,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,			KEY_NULL,		KEY_TO_PP_NETWORK_FM,	KEY_NULL
    },
    [1] = {
        KEY_NULL,	KEY_NULL,	KEY_NULL,			KEY_NULL,		KEY_NULL,	KEY_NULL
    },
